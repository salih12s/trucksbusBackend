...
import { reportService, getReasonLabel, getStatusLabel, type Report, type ReportStatus, type ReportReason } from '../../services/reportService';
                      ...
                      <List>
                        {detailDialog.report.history.map((historyItem, index) => (
                          <React.Fragment key={historyItem.id}>
                            ...
                            {index < detailDialog.report.history.length - 1 && (
                              <Divider />
                            )}
                          </React.Fragment>
                        ))}
