...
const TekstilForm: React.FC = () => {
  ...
  const handleInputChange = (field: keyof TekstilFormData, value: any) => {
        ...
        return (
          <Stack spacing={3}>
            ...
            <TextField
              ...
              placeholder="Tekstil aracınız hakkında detaylı bilgi verin..."
              required
            />
          ...
          <Paper sx={{ p: 4 }}>
            ...
            <Box sx={{ textAlign: 'center', mb: 4 }}>
              <Typography variant="h4" gutterBottom sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2 }}>
                <LocalLaundryService fontSize="large" color="primary" />
                Tekstil İlan Ver
              </Typography>
              <Typography variant="subtitle1" color="text.secondary">
                Tekstil aracınızın detaylarını girin ve ilanınızı yayınlayın
              </Typography>
            </Box>
