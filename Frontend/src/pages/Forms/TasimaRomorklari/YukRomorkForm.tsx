...
interface YukRomorkFormData {
  title: string;
  description: string;
  productionYear: string;
  hasDamper: boolean;
  isExchangeable: string;
  usageArea: string; // Ekstra alan - Kullanım Alanı
...
const YukRomorkForm: React.FC = () => {
  ...
  const handleInputChange = (field: keyof YukRomorkFormData, value: any) => {
