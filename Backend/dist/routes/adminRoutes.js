...
router.get('/dashboard/activities', adminController_1.getRecentActivities);
router.get('/listings', adminController_1.getListings);
router.get('/listings/pending', adminController_1.getPendingListings);
router.get('/listings/:id', adminController_1.getListingDetail);
...
router.delete('/listings/:id', adminController_1.hardDeleteListing);
